defmodule CAToolsWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: CAToolsWeb.Gettext
  ...
  def input(assigns) do
    assigns = normalize_input_assigns(assigns)
    ...
    case assigns[:type] do
      ...
      "checkbox" ->
        checkbox_input(assigns)

      "select" ->
        select_input(assigns)

      "textarea" ->
        textarea_input(assigns)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CAToolsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CAToolsWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  defp normalize_input_assigns(%{field: %Phoenix.HTML.FormField{} = field} = assigns) do
    errors =
  ...
  defp normalize_input_assigns(assigns), do: assigns
