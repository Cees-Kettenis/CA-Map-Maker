defmodule CATools.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias CATools.Accounts.UserToken
  ...
  @type t :: %__MODULE__{
          ...
          user_id: integer() | nil,
          user: CATools.Accounts.User.t() | Ecto.Association.NotLoaded.t() | nil
        }
  ...
  """
  @spec build_session_token(CATools.Accounts.User.t()) :: {binary(), t()}
  ...
  """
  @spec build_email_token(CATools.Accounts.User.t(), String.t()) :: {String.t(), t()}
